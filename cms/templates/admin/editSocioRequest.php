<?php include "templates/include/header.php" ?>
    ...
    <h1 class="section-title">Approva Socio</h1>
    ...
    <form action="admin.php?action=<?php echo $results['formAction']?>" method="post">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" name="personal_id" id="personal_id" placeholder="Numero socio" maxlength="255" value="<?php echo Socio::getNextPersonalId()?>" readonly/>
            </li>
            ...
            <li style="display: none">
                ...
                <input type="radio" id="state" name="state" value="0" checked/> APPROVATO
                <input style="margin-left: 24px" type="radio" id="state" name="state" value="1"/> IN APPROVAZIONE
            </li>
...
<?php if ( $results['socio']->id ) { ?>
    <p><a href="admin.php?action=deleteSocio&amp;socioId=<?php echo $results['socio']->id ?>" onclick="return confirm('Eliminare il socio dal sistema?')">Elimina richiesta</a></p>
<?php } ?>
