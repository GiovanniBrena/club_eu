...
foreach ($results['last'] as $newsletter ) {
    $lastName = $newsletter->title_en;
    $lastPath = $newsletter->path_en;
}
...
foreach ($results['list'] as $newsletter ) {
    ...
    $response = $response . ' <li class="nl-dd-item"><a href="../cms/'.$newsletter->path_en.'" target="_blank">'.$newsletter->title_en.'</a></li>';
}
